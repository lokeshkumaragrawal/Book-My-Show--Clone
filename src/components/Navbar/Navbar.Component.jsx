...
function NavMedium() {
  return (
    ...
    <div className="w-full flex place-items-centre px-3 py-1 rounded-md">
...
// Main Component
const Navbar = () => {
  return ( <nav className="bg-darkBackground-400 px-4 py-3">
    {/* Mobile Screen Navbar */}
    <div className='md:hidden'>
      <NavSmall />
    </div>
    {/* Medium/tablet  Screen Navbar */}
    <div className='hidden md:flex lg:hidden'>
      <NavMedium />
    </div>
    {/* large  Screen Navbar */}
    <div className='hidden hidden md:flex'>
      <NavLarge />
    </div>
    </nav>
