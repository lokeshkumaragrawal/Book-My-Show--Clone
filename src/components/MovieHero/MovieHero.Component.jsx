...
import MovieInfo from '../MovieHero/MovieInfo.Component'
  ...
  <>
    <div>
      ...
      style={{ height: "30rem" }}>
        ...
        <img src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt='Movie backdrop' className='w-full h-full object-cover object-center'/>
